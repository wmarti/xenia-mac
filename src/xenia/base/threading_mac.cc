...
// TODO(wmarti): This file is based on xenia-canary's threading_posix.cc and is
// not yet aligned with xenia-edge's newer POSIX threading changes.
// TODO(wmarti): Review/port edge changes (robust mutexes, per-instance condition
// variables + WaitMultiple polling, signal/self-suspend updates, and Windows-
// semantics suspend/release behavior).
