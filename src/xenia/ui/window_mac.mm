...
void MacWindow::HandleKeyEvent(void* event, bool is_down) {
  ...
  switch (key_code) {
    case 48:  virtual_key = VirtualKey::kTab; break;    // Tab
    case 36:  virtual_key = VirtualKey::kReturn; break; // Return
    case 51:  virtual_key = VirtualKey::kBack; break;   // Backspace
    case 53:  virtual_key = VirtualKey::kEscape; break; // Escape
    case 49:  virtual_key = VirtualKey::kSpace; break;  // Space
    case 114: virtual_key = VirtualKey::kInsert; break; // Insert
    case 115: virtual_key = VirtualKey::kHome; break;   // Home
    case 119: virtual_key = VirtualKey::kEnd; break;    // End
    case 116: virtual_key = VirtualKey::kPrior; break;  // Page Up
    case 121: virtual_key = VirtualKey::kNext; break;   // Page Down
    case 117: virtual_key = VirtualKey::kDelete; break; // Delete
    case 123: virtual_key = VirtualKey::kLeft; break;   // Left
    case 124: virtual_key = VirtualKey::kRight; break;  // Right
    case 125: virtual_key = VirtualKey::kDown; break;   // Down
    case 126: virtual_key = VirtualKey::kUp; break;     // Up
    case 56:  virtual_key = VirtualKey::kShift; break;  // LShift
    case 60:  virtual_key = VirtualKey::kShift; break;  // RShift
    case 59:  virtual_key = VirtualKey::kControl; break; // LCtrl
    case 62:  virtual_key = VirtualKey::kControl; break; // RCtrl
    case 58:  virtual_key = VirtualKey::kMenu; break;   // LAlt
    case 61:  virtual_key = VirtualKey::kMenu; break;   // RAlt
    case 55:  virtual_key = VirtualKey::kLWin; break;   // LCmd
    case 54:  virtual_key = VirtualKey::kLWin; break;   // RCmd
    case 18:  virtual_key = VirtualKey::k1; break;      // 1
    case 19:  virtual_key = VirtualKey::k2; break;      // 2
    case 20:  virtual_key = VirtualKey::k3; break;      // 3
    case 21:  virtual_key = VirtualKey::k4; break;      // 4
    case 23:  virtual_key = VirtualKey::k5; break;      // 5
    case 22:  virtual_key = VirtualKey::k6; break;      // 6
    case 26:  virtual_key = VirtualKey::k7; break;      // 7
    case 28:  virtual_key = VirtualKey::k8; break;      // 8
    case 25:  virtual_key = VirtualKey::k9; break;      // 9
    case 29:  virtual_key = VirtualKey::k0; break;      // 0
