...
if _ios then
  ...
  -- Capture the third_party directory now (at load time) so that
  -- sdl2_include() resolves the path correctly regardless of which
  -- script directory it is called from later.
